...
function LVcalibration_Parallel_LVData( type )

%Inputs:
% type: Competitive, Mutual, or RantagC


dataLocation = ['Data/LVData/' type ];
figLocation = ['Figures/Parallel_LVData/' type '/'];
mkdir(figLocation)
...
for p1 = 1:9
    for p2 = 1:9
        ...
        if p1==p2
            ...
            idx = [1:8; 9:16];% determine which data belongs to which data set
